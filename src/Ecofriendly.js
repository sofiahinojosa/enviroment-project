    ...
    return(
        <div className="Veganism">
            ...
            <p>Even if you just make one change rather than turning <strong>your entire household eco-friendly overnight,</strong> 
                you're working to <strong>build better habits</strong> in your corner of the world. </p>
            ...
            <p>It's surprisingly simple to make <strong>positive changes to your lifestyle</strong>
                  ...
                  it for a reusable coffee filter. Out of laundry detergent? Try one
                   with better ingredients. You don't have to subsist on whatever your
                    backyard garden grows to make a difference or feel guilty that your
                     trash doesn't fit in a mason jar. <strong>Try to shop local when possible,</strong>
